            ...
            <View style={[this.props.style, { flex: this.props.flex || 1, flexDirection: this.props.vertical ? 'column' : 'row', height: this.props.height }]}>
                {
                    this.props.cols.map((col) => {
                        return <TouchableOpacity activeOpacity={0.8}  key={Math.random()} onPress={col.onPress} style={[{ flex: col.flex, height: '100%',backgroundColor:col.backgroundColor ||'#f3f3f3', margin: this.props.margin || 0, }]}>
