        ...
        return (
            ...
            <View >
                ...
                <View style={{ margin: 10, }}>
...

                    {
                        this.props.shortText ?
                            <TouchableOpacity style={{}} onPress={() => { Actions.EntityComments({ entity: this.props.entity }) }}>
                ...
                <View style={{ margin: 8, flexDirection: 'row' }}>
                    ...
                    <Col style={{ flex: 1 }} onPress={() => { Actions.EntityComments({ entity: this.props.entity }) }}>
